...
if __name__ == "__main__":
    ...
    img_paths = ['/mnt/d/FPT-AI/CVPR24/CVPR_datasets/GMOT40/test/car-3/img1/000001.jpg']       # path of images
    labels = ["red car"]          # labels to be predicted
    prompt = 'detect only {}.'.format(','.join(labels))        # prompt of detection task, use "Detect {}." as default
